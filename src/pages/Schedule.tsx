    ...
    <div className="pt-16">
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Schedule */}
          <div className="mb-16">
            <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">Planning des cours</h2>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {Object.entries(groupedSchedule).map(([day, classes]: [string, any[]]) => (
                  <div key={day} className="bg-gray-50 rounded-lg p-6">
                    <h3 className="text-xl font-bold text-red-600 mb-6 text-center">{day}</h3>
                    <div className="space-y-4">
                      {classes.map((classItem: any) => (
                        <div key={classItem.id} className="bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow duration-300">
                          ...
                          <h4 className="font-bold text-gray-900 mb-1">{classItem.description}</h4>
          ...
          {/* Pricing */}
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">Tarifs annuels</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {pricing.map((price, index) => (
                <div key={index} className="bg-white border-2 border-gray-200 rounded-lg p-6 hover:border-red-600 transition-colors duration-300">
                  <h3 className="text-lg font-bold text-gray-900 mb-4">{price.category}</h3>
